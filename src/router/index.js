...
const routes = [
  ...
  },
  {
    ...
    redirect: { name: 'Wel' },
    children: [
      { path: 'wel', name: 'Wel', component: () => import('@/views/wel.vue') }
...
// 定义权限路由
const asyncRoutes = {
  user1: { path: 'user1', name: 'User', component: () => import('../views/user1.vue') },
  user2: { path: 'user2', name: 'User2', component: () => import('@/views/user2.vue') },
  juese: { path: 'juese', name: 'Juese', component: () => import('@/views/juese.vue') },
  cate1: { path: 'cate1', name: 'Cate1', component: () => import('@/views/cate1.vue') },
  cate2: { path: 'cate2', name: 'Cate2', component: () => import('@/views/cate1.vue') }
}
